...
//   //         if (wS > (hT + hH - wH)) {
//   //           //console.log('require parallax ');
//   //           // require.ensure(['./parallax/parallax'], function(require){
...
//   // var objTeam = {
//   //   window: window,
//   //   elem: '.grid__template_extra',
//   //   script: ['./parallax/parallax.js']
//   // };

//   // func.param(objTeam).ScrollToProgressBar();
...
//var parallax = require('./parallax/parallax.js');
...
$(document).ready(function(){
  ...
  $(window).scroll(function() {
    ...
    $(".header .header__m.animated:eq(0)").each(function() {
      if (isScrolledIntoView(this) === true) {
        $(this).addClass("fadeInLeft");
      }
    });

    $(".header .header__m.animated:eq(1)").each(function() {
      if (isScrolledIntoView(this) === true) {
        $(this).addClass("fadeInRight");
      }
    });

    $(".header .header__m.animated:eq(2), .header .header__m.animated:eq(3)").each(function() {
      if (isScrolledIntoView(this) === true) {
    ...
    $(".header .header__l.animated").each(function() {
      if (isScrolledIntoView(this) === true) {
        $(this).addClass("fadeUpIn");
      }
    });

    $(".island span.animated").each(function() {
      if (isScrolledIntoView(this) === true) {
        $(this).addClass("fadeUpIn");
      }
    });

    // $(".header .header__m.animated:second").each(function() {
    //   if (isScrolledIntoView(this) === true) {
    //     $(this).addClass("fadeInRight");
    //   }
    // });

    $(".grid__extra .text.animated").each(function() {
      if (isScrolledIntoView(this) === true) {
        $(this).addClass("zoomIn");
      }
    });

    $(".island.animated").each(function() {
      if (isScrolledIntoView(this) === true) {
        $(this).addClass("fadeInUpBig");
      }
    });

    $(".stream .achievement__fig img").each(function() {
      if (isScrolledIntoView(this) === true) {
        $(this).addClass("fadeUpIn");
      }
    });
    ...
    if ($(window).scrollTop() >= 250) {
      $('.grid__template_1_4').addClass('header__fixed');
    } else {
      $('.grid__template_1_4').removeClass('header__fixed');
    }
  ...
  //       var percentageVal = Math.round(this.percentage * 10);
